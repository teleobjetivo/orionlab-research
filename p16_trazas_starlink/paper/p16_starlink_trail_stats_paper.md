    # Starlink Trails Statistics from Santiago

    **Short Title:** Starlink Trails Statistics from Santiago  
    **Project ID:** P16_STARLINK_TRAIL_STATS  
    ...
    **Version:** 0.1 – 2025-12-11
    ...
    We provide a small observational-style dataset on Starlink satellite trails as recorded from Santiago, Chile, offering simple statistics for teaching and exploration.
