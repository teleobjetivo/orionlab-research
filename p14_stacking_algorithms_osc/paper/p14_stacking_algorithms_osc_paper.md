    # Comparing Stacking Algorithms for OSC Cameras

    **Short Title:** Comparing Stacking Algorithms for OSC Cameras  
    **Project ID:** P14_STACKING_ALGORITHMS_OSC  
    ...
    **Version:** 0.1 – 2025-12-11
    ...
    We compare stacking strategies and dithering patterns for one-shot colour cameras, showing their impact on SNR, background noise and residual patterns under bright skies.
