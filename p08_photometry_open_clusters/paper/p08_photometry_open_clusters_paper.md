    # Simple Photometry of Southern Open Clusters

    **Short Title:** Simple Photometry of Southern Open Clusters  
    **Project ID:** P08_PHOTOMETRY_OPEN_CLUSTERS  
    ...
    **Version:** 0.1 – 2025-12-11
    ...
    We explore basic aperture photometry of southern open clusters using a synthetic dataset designed to replicate typical noise, seeing and SNR conditions for DSLR / OSC cameras.
